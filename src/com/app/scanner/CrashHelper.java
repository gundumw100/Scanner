...
public final class CrashHelper {
    ...
    private static final String EXTRA_RESTART_ACTIVITY_CLASS = "com.app.base.EXTRA_RESTART_ACTIVITY_CLASS";
    private static final String EXTRA_SHOW_ERROR_DETAILS = "com.app.base.EXTRA_SHOW_ERROR_DETAILS";
    private static final String EXTRA_STACK_TRACE = "com.app.base.EXTRA_STACK_TRACE";

    //General constants
    private final static String TAG = "CustomActivityOnCrash";
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "com.app.base.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "com.app.base.RESTART";
    private static final String CAOC_HANDLER_PACKAGE_NAME = "com.app.base";
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.app.base.RESTART" />,
    ...
    private static Class<? extends Activity> guessRestartActivityClass(Context context) {
        ...
        resolvedActivityClass = CrashHelper.getRestartActivityClassWithIntentFilter(context);
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.app.base.RESTART" />,
     ...
     * It will first get activities from the AndroidManifest with intent filter <action android:name="com.app.base.ERROR" />,
    ...
    private static Class<? extends Activity> guessErrorActivityClass(Context context) {
        ...
        //If action is defined, use that
        resolvedActivityClass = CrashHelper.getErrorActivityClassWithIntentFilter(context);
    ...
    /**
     * INTERNAL method used to get the first activity with an intent-filter <action android:name="com.app.base.ERROR" />,
     * If there is no activity with that intent filter, this returns null.
     *
     * @param context A valid context. Must not be null.
     * @return A valid activity class, or null if no suitable one is found
